...
// Import images
import eventImage1 from '/public/images/events/event_image_1.png';
import eventImage2 from '/public/images/events/event_image_2.png';
import eventImage3 from '/public/images/events/event_image_3.png';
import eventImage4 from '/public/images/events/event_image_4.png';
                ...
                <li key={event.id} data-aos="fade-up" data-aos-duration="800" data-aos-delay={`${100 * (index + 1)}`}>
                  <div className="event_card_block">
                    <Link onClick={ClickHandler} className="event_image" href={event.ticketUrl}>
                      <Image src={event.imageUrl} alt="Event" width={1256} height={762} />
                    </Link>
              ...
              {events.slice(1).map((event, index) => (
                <li key={event.id} data-aos="fade-up" data-aos-duration="800" data-aos-delay={`${100 * (index + 1)}`}>
                  <div className="event_block_left_image">
                    <Link onClick={ClickHandler} className="event_image" href={event.ticketUrl}>
                      <Image src={event.imageUrl} alt="Event" width={996} height={664} />
